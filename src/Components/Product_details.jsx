          ...
          {!data ? (
            ...
            <Right_div>
              ...
              <ButtonsContainer>
                ...
                <AddToCartButton onClick={(e) => Addtocart(e, data)}>
                  Add to Cart
                </AddToCartButton>
              </ButtonsContainer>
              <Logo_Container>
                <img
                  src="https://cdn.shopify.com/s/files/1/1199/8502/files/secured-payment-icon.png?v=1666161113"
                  alt=""
                />

                <img
                  src="https://cdn.shopify.com/s/files/1/1199/8502/files/COD-icon.png?v=1666161113"
                  alt=""
                />

                <img
                  src="https://cdn.shopify.com/s/files/1/1199/8502/files/exchange-icon.png?v=1666161113"
                  alt=""
                />
              </Logo_Container>
              <Logo_text>
